    ...
    protected function validateBaseUrl(): bool
    {
        if (empty($this->baseUrl)) {
            $this->fail([
                ...
                '<mark>config/autoload/local.php["laminas-security"]["app"]["url"]</mark> before running this check</fail>',
            ...
            $this->fail([
                '<fail>Invalid Application-URL</fail> at <mark>config["laminas-security"]["app"]["url"]</mark>. ' .
